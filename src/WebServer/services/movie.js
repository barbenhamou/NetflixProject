...
module.exports = {
    createMovie, getMovieById, getMovieByShortId, getMovies, replaceMovie, deleteMovie, searchInMovies, categoriesStringToId, watchMovie, recommendMovies, getMovieFiles
};